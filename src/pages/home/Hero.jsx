...
const Hero = () => {
  const handleWhatsApp = () => {
    window.open(
      "https://wa.me/919703049286?text=Hi%2C%20I%20would%20like%20to%20book%20a%20demo.",
      "_blank"
    );
  };
  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage:
            "url('https://demoapus1.com/educrat/learnpress/wp-content/uploads/2022/07/home1-bg.png')",
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
              Accelerate Your Skill Development <br /> With{" "}
              <span className="text-[#00FF9C]">GSR IT Solutions</span>
            </h1>
            <p className="text-gray-300 mb-8 max-w-md">
              GSR IT Solutions delivers innovative technology, consulting, and
              digital transformation services to help your business grow and
              succeed in a digital world.
            </p>
            <div className="flex gap-4 mb-8">
              <button
                className="bg-[#7C4DFF] text-white px-6 py-3 rounded-lg font-semibold"
                onClick={handleWhatsApp} // Open WhatsApp for Free Demo
              >
                Free Demo
              </button>
              <button
                className="border border-[#00FF9C] text-[#00FF9C] px-6 py-3 rounded-lg font-semibold"
                onClick={handleWhatsApp} // Open WhatsApp for Job Guarantee
              >
          ...
          <div className="relative w-full h-[420px] min-h-[340px] flex items-end justify-center">
            ...
            <div className="absolute left-0 bottom-[-40px] bg-white px-6 py-4 rounded-2xl shadow-xl flex items-center gap-3 z-20 min-w-[180px]">
              ...
              <div>
                <p className="font-bold text-[#FF6B00] text-lg leading-tight">
                  30,000
                </p>
            ...
            <div className="absolute right-0 bottom-[-40px] bg-white px-6 py-4 rounded-2xl shadow-xl flex items-center gap-3 z-20 min-w-[210px]">
              ...
              <div>
                <p className="font-bold text-[#7C4DFF] leading-tight">
                  Congrats!
                </p>
